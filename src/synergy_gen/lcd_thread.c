 ...
 *            - void sf_touch_panel_i2c_init(void)
 **********************************************************************************************************************/
void sf_touch_panel_i2c_init(void)
{
...
void lcd_thread_create(void)
{
    ...
    UINT err_g_lcd_semaphore;
    err_g_lcd_semaphore = tx_semaphore_create (&g_lcd_semaphore, (CHAR *) "LCD Semaphore", 0);
