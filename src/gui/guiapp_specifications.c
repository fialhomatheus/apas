...
GX_PROMPT_PROPERTIES window1_distance_properties =
{
    GX_STRING_ID_DISTANCE,                   /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
GX_PIXELMAP_PROMPT_PROPERTIES window1_carprompt_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    ...
    GX_PIXELMAP_ID_CAR_TOP_VIEW,             /* left pixelmap id               */
    0,                                       /* fill pixelmap id               */
    0,                                       /* right pixelmap id              */
...
GX_CONST GX_STUDIO_WIDGET window1_carprompt_define =
{
    "carprompt",
    GX_TYPE_PIXELMAP_PROMPT,                 /* widget type                    */
    ID_CARPROMPT,                            /* widget id                      */
    ...
    {58, 24, 182, 273},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_carprompt), /* control block       */
    (void *) &window1_carprompt_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_distance_define =
{
    "distance",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_DISTANCE,                             /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 280, 239, 303},                      /* widget size                    */
    &window1_carprompt_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_distance), /* control block        */
    (void *) &window1_distance_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window1_distance_define,                /* child widget                   */
    0,                                       /* control block                  */
